...
class SbbApplicationTests {
	...
	/* question 테이블에 for문을 사용해서 더미 값 1000개 insert 
	@Test
	...
	*/
	...
	public void testjpa8 () {
		...
		Optional <Question> op =
				this.questionRepository.findById(3);	//1번 레코드를 게더링해서 q 객체에 담고 Optional Question객체에 집어넣는다
	...
	*/
	...
	public void testAnswerjpa() {
		...
		Optional <Question> op =
				this.questionRepository.findById(3);	//3번 글에 대한~~
		Question q = op.get();
 ...
 public void testjpa6 () {
	...
	*/
	...
	public void  testjpa4 () {
		...
		System.out.println("총 리스트에 있는 객체수 : " + all2.size());
	...
	*/
	...
	/* 조건에 맞는 레코드 하나만 가져 오기 : PK컬럼은 findById(1)
	@Test
